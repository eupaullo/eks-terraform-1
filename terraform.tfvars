...
#  eks_version                        = "1.24" # upgrade controlplane first then update eks_version_latest_ami to the same version
#  eks_version_latest_ami             = "1.24"
